...
{
	private const string ConfigDirectoryName = "Bepinex/config/ETS/Config/Moderation";
	private const string ConfigFileName = "moderation_mod_config.json";
    ...
    public static ModerationModConfigData Config { get; private set; } = new ModerationModConfigData();
    ...
    public static void Load()
	{
		...
		try
		{
			...
			Config = JsonSerializer.Deserialize<ModerationModConfigData>(jsonData, SerializerOptions) ?? new ModerationModConfigData();
		}
		catch (Exception ex)
		{
			Config = new ModerationModConfigData();
...
public class ModerationModConfigData
{
	public int ClanJoinCooldownMinutes { get; set; } = 60*8;
}