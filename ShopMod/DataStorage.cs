...
{
	private const string ConfigDirectoryName = "Bepinex/config/ETS/Data/ShopMod";
	...
	public static void Save()
	{
		try
		{
			...
			File.WriteAllTextAsync(FullPath, jsonData);
		}
		catch (Exception ex)
		{
            Plugin.PluginLog.LogInfo(ex.ToString());
...
{
	public HashSet<Player> PlayersWhoUsedKits { get; set; } = new();
	public Dictionary<ulong, DateTime> PlayerPurchaseDates { get; set; } = new();
}
