...
using InstabreachGolem;
using static ModCore.Configs.ConfigDtos;

public static class InstabreachGolemConfig
{
	private const string ConfigDirectoryName = "Bepinex/config/ETS/Config/InstabreachGolem";
	private const string ConfigFileName = "instabreach_golem_config.json";
    ...
    public static InstabreachGolemConfigData Config { get; private set; } = new InstabreachGolemConfigData();
    ...
    public static void Load()
	{
		...
		try
		{
			...
			Config = JsonSerializer.Deserialize<InstabreachGolemConfigData>(jsonData, SerializerOptions) ?? new InstabreachGolemConfigData();
		}
		catch (Exception ex)
		{
			Config = new InstabreachGolemConfigData();
...
public class InstabreachGolemConfigData
{
